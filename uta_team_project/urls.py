...
urlpatterns = patterns('',
    ...
    url(r'^select_team/(?P<team_id>.*)/(?P<assignment_id>.*)/', views.select_team, name='select_team'),
    ...
    url(r'^notification_reject/(?P<group_id>.*)/', views.notification_reject, name='notification_reject'),
